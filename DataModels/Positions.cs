...
namespace FantasySports.DataModels
{
    ...
    public static class Positions
    {
        ...
        { Position.C, Position.B1, Position.B2, Position.B3, Position.SS, Position.OF, Position.Util, Position.P, Position.SP, Position.RP };
        ...
        public static string ToString(Position p)
        {
            switch (p)
            {
                ...
                case Position.SP: return "Starting Pitcher";
                case Position.RP: return "Relief Pitcher";
        ...
        public static string ToShortString(Position p)
        {
            switch (p)
            {
                ...
                case Position.SP: return "SP";
                case Position.RP: return "RP";
