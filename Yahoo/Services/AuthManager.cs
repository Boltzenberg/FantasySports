...
namespace Yahoo.Services
{
    public class AuthManager
    {
        ...
        public static Uri GetAuthUrl()
        {
            ...
            uriBuilder.Query = string.Format("client_id={0}&redirect_uri=oob&response_type=code&language=en-us", YConstants.OAuth.ClientID);
        ...
        { 
            ...
            req.Method = "POST";
            byte[] authData = Encoding.UTF8.GetBytes(string.Format("{0}:{1}", YConstants.OAuth.ClientID, YConstants.OAuth.ClientSecret));
